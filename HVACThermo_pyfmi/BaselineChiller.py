"""
@author: Tianyi Chen
Version 1.0, 05/15/2018, Framework completed.
Version 1.1, 05/16/2018, For loop run for each time iteration.
"""
...
class runBaselineChillerModel():
	...
	def __init__(self, csvFilePath, modelPath, idx_start, idx_end, V_a, V_w, epsilon, phi_min, t_lcmin, deltaCOP, deltaQ, deltaWc, W_fan):
		"""
		Inputs:
